...
{{--                       
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input  class="block mt-1 w-full" type="text" readonly value="{{$patient->lastname .' '.$patient->name }}"/>
                            <x-text-input class="block mt-1 w-full" type="hidden"
                                name="user_id"  value="{{$patient->id}}"/>
                            <x-input-error :messages="$errors->get('user_id')" class="mt-2" />
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input class="block mt-1 w-full" type="number" step="0.01" min="0"
                                name="weight" />
