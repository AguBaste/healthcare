         ...
         <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
             <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                 <div class="p-6 text-gray-900 dark:text-gray-100">
                     <form method="POST" action="{{ route('pressure.store') }}">
                         @csrf

                         <!-- systolic -->
                         <div>
                             <x-input-label for="systolic" value="presión sistólica" />
                             <x-text-input class="block mt-1 w-full" type="number" step="0.1" min="0"
                         ...
                         <div>
                             ...
                             <x-text-input class="block mt-1 w-full" type="number" step="1" min="0"
