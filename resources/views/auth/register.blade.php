    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="dni" class="block mt-1 w-full" type="text" name="dni"
                value="{{ old('dni') }}" required autofocus autocomplete="name" />
        ...
        <div>
            ...
            <x-text-input id="insurance" class="block mt-1 w-full" type="text" name="insurance"
                value="{{ old('insurance') }}" required autofocus autocomplete="insurance" />
        ...
        <div>
            ...
            <x-text-input id="member_id" class="block mt-1 w-full" type="text" name="member_id"
                value="{{ old('member_id') }}" required autofocus autocomplete="member_id" />
        ...
        <div>
            ...
            <x-text-input id="dob" class="block mt-1 w-full" type="date" name="dob"
                value="{{ old('dob') }}" required autofocus autocomplete="name" />
