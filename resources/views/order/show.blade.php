...
<body>
    ...
    <div class="contenedor">
        ...
        <ul class="flex flex-col gap-2 mt-4 capitalize">
            <li>paciente: <span class="font-bold">{{ $order->user->name . ' ' . $order->user->lastname }}</span></li>
            <li class="uppercase">dni: <span class="font-bold">{{ $order->user->dni }}</span> </li>
            <li>obra social: <span class="font-bold">{{ $order->user->insurance }}</span> </li>
            <li>plan: <span class="font-bold">{{ $order->user->plan }}</span> </li>
            <li>nuúmero de afiliado: <span class="font-bold"> {{ $order->user->member_id }}</span></li>
        </ul>
        <ul class="flex flex-col gap-2 mt-4">
            <li class="capitalize font-bold">fecha: {{ $order->date->format('d-m-Y') }}</li>
            <li class="uppercase">RP</li>
            <li class="italic">{{ $order->study }}</li>
            <li class="italic"><span class="font-bold">diagnostico:</span> {{ $order->diagnostic }}</li>
        </ul>
        <ul class="flex justify-between mt-4">
            <li class="capitalize">dr: <span class="font-bold">{{ auth()->user()->name . ' ' . auth()->user()->lastname }}</span></li>
        ...
        <p class="capitalize font-bold mt-24">Firma:</p>
        <div class="flex justify-around">
            <x-primary-a id="print" class="mt-4">
                imprimir
            </x-primary-a>
            <x-primary-a id="edit" href="{{ route('order.edit', $order) }}" class="mt-4">
                editar
            </x-primary-a>
        </div>
